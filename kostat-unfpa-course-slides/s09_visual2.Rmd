---
title: Sankey Plots for Visualising Bilateral Migration 
author: Guy J. Abel
date: 
fontsize: 10pt
output:
...
\begin{center}
  \includegraphics[width=\textwidth]{./img/Minard-napolean.png}
\end{center}

### Sankey plot of migration in Nature by @Butler2017

\begin{center}
  \includegraphics[width=\textwidth]{./img/Migration_Graphic.pdf}
\end{center}
...
```{r sankey-default, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s,
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-default-1.pdf")
```
...
```{r sankey-x-axis, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
levels(s$x)
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-x-axis-1.pdf")
```
...
```{r sankey-set-axis, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
# default axis.width
ggplot(data = s,
       mapping = aes(x = x, id = id, value = stock, split = y)) +
  geom_parallel_sets() +
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-set-axis-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-set-axis-2.pdf")
```
...
```{r sankey-col,  fig.width = 6, fig.height = 4, message=TRUE,  warning= TRUE,  fig.show='hide', fig.path="./plot/"}
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-col-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-col-2.pdf")
```
...
```{r sankey-col-tran,  fig.width = 6, fig.height = 4, message=TRUE,  warning= TRUE,  fig.show='hide', fig.path="./plot/"}
# transparency of 0.8
ggplot(data = s, mapping = aes(x = x, id = id, value = stock, split = y)) +
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-col-tran-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-col-tran-2.pdf")
```
...
```{r sankey-axis-col, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-axis-col-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-axis-col-2.pdf")
```
...
```{r sankey-axis-fill, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s, mapping = aes(x = x, id = id, value = stock, split = y)) +
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-axis-fill-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-axis-fill-2.pdf")
```
...
```{r sankey-default-lab, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s, mapping = aes(x = x, id = id, value = stock, split = y)) +
  geom_parallel_sets(mapping = aes(fill = orig), alpha = 0.8, axis.width = -0.05) +
  geom_parallel_sets_axes(fill = "transparent", colour = "black", 
                          axis.width = 0.05) +
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-default-lab-1.pdf")
```
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-default-lab-2.pdf")
```
...
```{r sankey-fct, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s,
       mapping = aes(x = x, id = id, value = stock, split = y)) +
  geom_parallel_sets(mapping = aes(fill = orig), alpha = 0.8, axis.width = -0.05) +
  geom_parallel_sets_axes(fill = "transparent", colour = "black", 
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-fct-1.pdf")
```
...
```{r sankey-lab, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s,
       mapping = aes(x = x, id = id, value = stock, split = y)) +
  geom_parallel_sets(mapping = aes(fill = orig), alpha = 0.8, 
                     axis.width = -0.05) +
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-lab-1.pdf")
```
...
```{r sankey-spacing, message=FALSE, fig.width = 6, fig.height = 4, message=FALSE,  warning= FALSE,  fig.show='hide', fig.path="./plot/"}
ggplot(data = s,
       mapping = aes(x = x, id = id, value = stock, split = y)) +
  geom_parallel_sets(mapping = aes(fill = orig), alpha = 0.8, 
...
\centering
```{r, echo = FALSE}
knitr::include_graphics("./plot/sankey-spacing-1.pdf")
```
