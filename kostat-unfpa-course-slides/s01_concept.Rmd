---
title: Migration Data and Concepts
author: Guy J. Abel
date: 
fontsize: 10pt
output:
  beamer_presentation:
    ...
    keep_tex: false
    includes:
      in_header: header-no-r-code.txt
...
\centering
\includegraphics[width=0.55\textwidth]{"./img/courgeau-1979-area"}
...
\vspace{-0.25cm}
\centering
\includegraphics[width=\textwidth]{"./img/rees-1977-non-migration"}
...
\centering
\includegraphics[width=0.9\textwidth]{"./img/courgeau-1979-period-a"}


### Migration Event Data 

\centering
\includegraphics[width=\textwidth]{"./img/courgeau-1979-period-b"}
...
\centering
\includegraphics[width=0.75\textwidth]{"./img/rees-1977-types"}
...
\vspace{-0.25cm}
\centering
\includegraphics[width=\textwidth]{"./img/rees-1977-one-five-a"}

### One-Year Five-Year Problem - Rees 1970

\vspace{-0.25cm}
\centering
\includegraphics[width=\textwidth]{"./img/rees-1977-one-five-b"}

### One-Year Five-Year Problem - Rees 1970

\vspace{-0.25cm}
\centering
\includegraphics[width=\textwidth]{"./img/rees-1977-one-five-c"}
